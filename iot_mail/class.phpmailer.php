...
class PHPMailer
{
     ...
     * @var string
     */
    public $CharSet = 'UTF-8';  //原始状态是iso-8859-1 （西欧语言）电子邮件中不能显示中文（乱码）改为 UTF-8 就可以了
     ...
     * @var string
     */
    public $FromName = 'EMS SUNLIGHT SERVICE';      //发出的电子邮件的属主名
     ...
     * @var string
     */
    public $Username = 'admin@ems156.com';

    /**
     * SMTP password.
     * @var string
     */
    public $Password = '70137018';
